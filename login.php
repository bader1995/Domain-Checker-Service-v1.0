            ...
            include 'controller/user.php';
                ...
                if(isset($_POST['login']))
                {
                     ...
                     if(login($email, $password))
                     {
						 ...
						 $query = "select id, type from users where email = '$email'";
                     ...
                     {
                         echo "<div class='alert alert-danger container'><strong>Error!</strong> Email / Password is incorrect, Please try again!</div>";
                     }
                }
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" method="post" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="login-username" type="email" class="form-control" name="email" value="" placeholder="email address">                                        
                                    </div>
