                    ...
                    <div class="profile-content" style="text-align:center">
                                ...
                                <div id="bulk_search">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <h2>Domains verification tool</h2>
 
                                          <textarea name="domains" class="form-control" cols="40" rows="20" placeholder="Please enter domains list."></textarea>
                                          <br>
                                        ...
                                        <br>
                                          ...
                                          <?php
                                            ...
                                            if(isset($_POST['verify']))
                                            {
                                              ...
                                              $domainz = $_POST['domains'];

                                              if($domainz !== "" || !empty($domainz))
                                              {
                                                $domains = explode("\n", str_replace("\r", "", $domainz));

                                                foreach($domains as $domain)
                                                {
  
                                                  if(domainAvailable($domain) == "YES")
                                                  {
                                                    $verification_result[] = $domain." : Available";
                                                    echo "<div class='container-fluid'><div class='alert alert-success'><b>$domain : </b> Available!</div></div>";
                                                  }else
                                                  {
                                                    $verification_result[] = $domain." : Not Available";
                                                    echo "<div class='container-fluid'><div class='alert alert-danger'><b>$domain : </b> Not Available!</div></div>";
                                                  }
  
                                                }

                                                //Write results to a file
                                                $file_name = "result-".rand(1,999).".txt";
                                                $file = fopen("result/".$file_name, "a");
                                                foreach($verification_result as $dm)
                                                {
                                                  $dm = $dm."\n\r";
                                                  fwrite($file,$dm);
                                                }
                                              ...
                                              {
                                                echo "<div class='container-fluid'><div class='alert alert-danger'><b>Error! </b>Please enter domains to verify!</div></div>";
                                              }
