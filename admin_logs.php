                        ...
                        <form method="post">
                          ...
                          <div id="result" class="container-fluid">
                              ...
                              <table class="table table-bordered table-striped">
                                  ...
                                  <th>Id</th> <th>First Name</th> <th>E-mail</th> <th>Credit</th> <th>Domain</th>
                                  ...
                                  <?php
                                    ...
                                    //Show all the information
                                      ...
                                      $query = "select (select id from users where users.id = domains.user) as id, ( select first_name from users where users.id = domains.user ) as first_name, ( select email from users where users.id = domains.user ) as email, ( select credit from users where users.id = domains.user ) as credit, link from domains";
                                        
                                      $resultp = mysqli_query($GLOBALS['connection'], $query);
