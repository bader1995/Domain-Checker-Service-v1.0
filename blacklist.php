            ...
            <div class="row profile">
        		...
        		<div class="col-md-9">
                  ...
                  if(isset($_POST['add']))
                  {
										...
										if(empty($_POST['words']) || $_POST['words'] == "")
										{
											echo "<div class='container-fluid'><div class='alert alert-danger'><b>Error! </b> Please enter words first!</div></div>";
										...
										}else
										{
											...
											foreach($words as $word)
											{
												if(!add_word($word))
												{
													echo '<div class="alert alert-danger container"><strong>Error! </strong>There is an error, please try again</div>';
												}
											}
											
											echo '<div class="alert alert-success container"><strong>Success! </strong>The words has been inserted successfully!</div>';
                        	...
                        	<div id="container">
                        		...
                        		<p><textarea name="words" class="form-control" rows="10" cols="40" placeholder="Please enter bad words list ..." <?php
                        		...
                        		<p><input type="submit" name="add" value="Add to blacklist" class="btn btn-primary"></p>
